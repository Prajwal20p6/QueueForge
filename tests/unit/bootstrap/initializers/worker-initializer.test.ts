...
import { WorkerInitializer } from '../../../../src/bootstrap/initializers/worker-initializer';

describe('WorkerInitializer Unit Tests', () => {
  ...
  it('should initialize and register worker module in container', async () => {
    ...
    const initializer = new WorkerInitializer(container);
